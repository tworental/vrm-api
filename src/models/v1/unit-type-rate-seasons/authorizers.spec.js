...
describe('unit-type-rate-seasons authorizers', () => {
  afterEach(() => {
    jest.clearAllMocks()
    jest.resetAllMocks()
  })
  ...
  it('should check a qouta authorizer', async () => {
    ...
    expect(authorizer.quota).toEqual([
      'account.module.properties.unitTypes.rateSeasons.limit',
      expect.any(Function),
    ])
  })
  ...
  it('should have a proper authorizer data', () => {
    expect(authorizer.module).toEqual([
      'account.module.rateSeasons.enabled', checkModule,
    ])
  })
})
