...
describe('GET /v1/app/service-providers/:id', () => {
  const id = 1
  const accountId = 92
  ...
  it('should show a resource', async () => {
    ...
    selectOneBy.mockResolvedValue(serviceProvider)
    ...
    expect(serialize).toBeCalledWith(PERMITED_ITEM_PARAMS, serviceProvider)
